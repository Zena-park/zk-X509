...
as a concrete case study. Korean digital certificates (공인인증서) are
issued by authorized CAs such as the Korea Financial Telecommunications
and Clearings Institute (금융결제원), employing a 3-level certificate
...
hierarchy: KISA Root CA → Authorized CA (e.g., 금융결제원) → User
Certificate.
...
\item
  ...
  (e.g., 금융결제원) whose root public key hash is whitelisted in
  \(\mathcal{V}\).
\end{itemize}
